...
if page == "🏠 Home":
    ...
    st.dataframe(missing_compare, width="stretch")
    ...
    st.plotly_chart(style_plotly(fig_r2), width="stretch")
    ...
    with c1:
        ...
        st.plotly_chart(style_plotly(fig_mae), width="stretch")
    ...
    with c2:
        ...
        st.plotly_chart(style_plotly(fig_rmse), width="stretch")
